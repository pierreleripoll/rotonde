...
Session(login='TTI',password='impro',typeAdmin='normal'),
Session(login='superadmin',password='larotonde',typeAdmin='super'),
Contact(nom="---",prenom="---",annee="",depart=""),

# Spectacle(nom='Candide',resume=lorem,admin='TTI',photos=1,directeur='John Doe',auteur='John Doe',participants='John Doe',infoComplementaire=lorem,tarif=3,duree=60,typeSpectacle='Theatre'),
# Spectacle(nom='Spectacle sans photo',resume=lorem,admin='TTI',photos=0,directeur='John Doe',auteur='John Doe',participants='John Doe',infoComplementaire=lorem,tarif=0,duree=60,typeSpectacle='Theatre'),
...
#
#
# Calendrier(date=datetime(2018,5,15,20,30),nom='Hamlet 60',placesRestantes=300),
# Calendrier(date=datetime(2018,5,27,20,30),nom='Chroniques Nocturne',placesRestantes=300),
# Calendrier(date=datetime(2018,5,28,20,30),nom='Chroniques Nocturne',placesRestantes=300),
# Calendrier(date=datetime(2018,5,29,20,30),nom='Chroniques Nocturne',placesRestantes=300),
# Calendrier(date=datetime(2018,5,30,20,30),nom='Chroniques Nocturne',placesRestantes=300),
# Calendrier(date=datetime(2018,5,31,20,30),nom='Chroniques Nocturne',placesRestantes=300),
# Calendrier(date=datetime(2018,6,1,20,30),nom='Chroniques Nocturne',placesRestantes=300),
# Calendrier(date=datetime(2018,6,2,20,30),nom='Jeanne de Derteil',placesRestantes=300),
# Calendrier(date=datetime(2018,6,3,20,30),nom='Spectacle sans photo',placesRestantes=300),
# Calendrier(date=datetime(2018,6,4,20,30),nom='Rapa Nui',placesRestantes=300),
# Calendrier(date=datetime(2018,6,5,20,30),nom='Rapa Nui',placesRestantes=300),
# Calendrier(date=datetime(2018,6,6,20,30),nom='Rapa Nui',placesRestantes=300),
# Calendrier(date=datetime(2018,6,7,20,30),nom='Rapa Nui',placesRestantes=300),
# Calendrier(date=datetime(2018,6,8,20,30),nom='Candide',placesRestantes=300),
# Calendrier(date=datetime(2018,6,9,20,30),nom='Candide',placesRestantes=300),
# Calendrier(date=datetime(2018,6,10,20,30),nom='Candide',placesRestantes=300),
